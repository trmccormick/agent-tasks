...
# TASK: Scout Ships — Seismic Survey Implementation (DEPRECATED)
**Status**: DEPRECATED
**Priority**: MEDIUM
**Type**: feature
**Created**: 2026-03-24
...
## Deprecation Note
This task is STALE — the codebase has diverged significantly since creation (March 2026).
All implementation details are wrong for current code. Intent preserved and split into 3 new tasks:

1. **Task A** (Phase 9a): `2026-07-15-HIGH-FEATURE-SCOUT-SHIP-CRAFT-DESIGN.md` — Scout ship as BaseCraft entry + JSON files
2. **Task B** (Phase 9a): `2026-07-15-HIGH-FEATURE-SEISMIC-SURVEY-MODE.md` — Seismic survey mode on WormholeScoutingService
3. **Task C** (Phase 9a/10d): `2026-07-15-HIGH-FEATURE-ASTEROID-INTEGRITY-GATE.md` — Integrity gate in StationCostBenefitAnalyzer
