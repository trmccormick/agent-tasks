...
Project: galaxy_game
Task: /Users/tam0013/Documents/git/agent-tasks/projects/galaxy_game/tasks/backlog/current/2026-08-31-HIGH-FEATURE-ASSET-UI-C1-implement-asset-registry-mapping.md

STEP 0 — MOVE TASK FILE BEFORE ANYTHING ELSE (no exceptions):
  git mv projects/galaxy_game/tasks/backlog/current/2026-08-31-HIGH-FEATURE-ASSET-UI-C1-implement-asset-registry-mapping.md \
