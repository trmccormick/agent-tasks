...
Project: galaxy_game
Task: /Users/tam0013/Documents/git/agent-tasks/projects/galaxy_game/tasks/backlog/current/2026-09-03-LOW-DOCUMENTATION-CLEANUP-DESIGN.md

STEP 0 — MOVE TASK FILE BEFORE ANYTHING ELSE (no exceptions):
  git mv projects/galaxy_game/tasks/backlog/current/2026-09-03-LOW-DOCUMENTATION-CLEANUP-DESIGN.md \
         projects/galaxy_game/tasks/active/2026-09-03-LOW-DOCUMENTATION-CLEANUP-DESIGN.md
...
LIFECYCLE: backlog → active → completed
  ...
  - Verify with: find agent-tasks/projects/galaxy_game/tasks -name "2026-09-03-LOW-DOCUMENTATION-CLEANUP-DESIGN.md"
...
CRITICAL: Save synthesis report as MD file to summaries folder BEFORE starting any work.
  ...
  Filename pattern: 2026-09-03-CLEANUP-design.md
  Chat is for questions only — never paste synthesis into chat (formatting breaks).
```

---

# TASK: Cleanup sweep — backlog/design/ (13 task files)
**Status**: BACKLOG
**Priority**: LOW
**Type**: documentation
**Created**: 2026-09-03
...
This task covers the `backlog/design/` folder specifically.

## Problem Statement

Task files in `backlog/design/` may have:
...
### Step 1 — Inventory
List all .md files in `backlog/design/` (excluding README.md).
Record count. Compare against expected: 13 files.
...
### Step 6 — Verify
```bash
find /Users/tam0013/Documents/git/agent-tasks/projects/galaxy_game/tasks -name "*.md" -path "*/design/*" | wc -l
```
...
git commit -m "chore: cleanup sweep backlog/design/ — [summary of fixes]"
```

## Acceptance Criteria
- [ ] All files in `backlog/design/` inventoried
