...
Project: galaxy_game
Task: /Users/tam0013/Documents/git/agent-tasks/projects/galaxy_game/tasks/backlog/current/2026-09-03-LOW-DOCUMENTATION-CLEANUP-ACT02-LOCAL-BUBBLE-EXPANSION.md

STEP 0 — MOVE TASK FILE BEFORE ANYTHING ELSE (no exceptions):
  git mv projects/galaxy_game/tasks/backlog/current/2026-09-03-LOW-DOCUMENTATION-CLEANUP-ACT02-LOCAL-BUBBLE-EXPANSION.md \
         projects/galaxy_game/tasks/active/2026-09-03-LOW-DOCUMENTATION-CLEANUP-ACT02-LOCAL-BUBBLE-EXPANSION.md
...
LIFECYCLE: backlog → active → completed
  ...
  - Verify with: find agent-tasks/projects/galaxy_game/tasks -name "2026-09-03-LOW-DOCUMENTATION-CLEANUP-ACT02-LOCAL-BUBBLE-EXPANSION.md"
...
CRITICAL: Save synthesis report as MD file to summaries folder BEFORE starting any work.
  ...
  Filename pattern: 2026-09-03-CLEANUP-act02-local-bubble-expansion.md
  Chat is for questions only — never paste synthesis into chat (formatting breaks).
```

---

# TASK: Cleanup sweep — backlog/act02-local-bubble-expansion/ (1 task files)
**Status**: BACKLOG
**Priority**: LOW
**Type**: documentation
**Created**: 2026-09-03
...
This task covers the `backlog/act02-local-bubble-expansion/` folder specifically.

## Problem Statement

Task files in `backlog/act02-local-bubble-expansion/` may have:
...
### Step 1 — Inventory
List all .md files in `backlog/act02-local-bubble-expansion/` (excluding README.md).
Record count. Compare against expected: 1 files.
...
### Step 6 — Verify
```bash
find /Users/tam0013/Documents/git/agent-tasks/projects/galaxy_game/tasks -name "*.md" -path "*/act02-local-bubble-expansion/*" | wc -l
```
...
git commit -m "chore: cleanup sweep backlog/act02-local-bubble-expansion/ — [summary of fixes]"
```

## Acceptance Criteria
- [ ] All files in `backlog/act02-local-bubble-expansion/` inventoried
