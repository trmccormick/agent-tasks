...
Project: galaxy_game
Task: /Users/tam0013/Documents/git/agent-tasks/projects/galaxy_game/tasks/backlog/current/2026-09-03-LOW-DOCUMENTATION-CLEANUP-PHASE14-EDEN-EXPANSION.md

STEP 0 — MOVE TASK FILE BEFORE ANYTHING ELSE (no exceptions):
  git mv projects/galaxy_game/tasks/backlog/current/2026-09-03-LOW-DOCUMENTATION-CLEANUP-PHASE14-EDEN-EXPANSION.md \
         projects/galaxy_game/tasks/active/2026-09-03-LOW-DOCUMENTATION-CLEANUP-PHASE14-EDEN-EXPANSION.md
...
LIFECYCLE: backlog → active → completed
  ...
  - Verify with: find agent-tasks/projects/galaxy_game/tasks -name "2026-09-03-LOW-DOCUMENTATION-CLEANUP-PHASE14-EDEN-EXPANSION.md"
...
CRITICAL: Save synthesis report as MD file to summaries folder BEFORE starting any work.
  ...
  Filename pattern: 2026-09-03-CLEANUP-phase14-eden-expansion.md
...
Task files in `backlog/phase14-eden-expansion/` may have:
...
### Step 1 — Inventory
List all .md files in `backlog/phase14-eden-expansion/` (excluding README.md).
Record count. Compare against expected: 14 files.
...
### Step 6 — Verify
```bash
find /Users/tam0013/Documents/git/agent-tasks/projects/galaxy_game/tasks -name "*.md" -path "*/phase14-eden-expansion/*" | wc -l
```
...
git commit -m "chore: cleanup sweep backlog/phase14-eden-expansion/ — [summary of fixes]"
```

## Acceptance Criteria
- [ ] All files in `backlog/phase14-eden-expansion/` inventoried
