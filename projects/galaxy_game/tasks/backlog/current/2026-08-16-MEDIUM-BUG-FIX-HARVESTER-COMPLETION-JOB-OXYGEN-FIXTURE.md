...
STEP 0 — MOVE TASK FILE BEFORE ANYTHING ELSE (no exceptions):
  ...
  Commit (EXPLICIT PATH ONLY):
    git add projects/galaxy_game/tasks/active/2026-08-16-MEDIUM-BUG-FIX-HARVESTER-COMPLETION-JOB-OXYGEN-FIXTURE.md
    git commit -m "Move oxygen diagnostic task to active, update status to active"
