...
Project: galaxy_game
Task: /Users/tam0013/Documents/git/agent-tasks/projects/galaxy_game/tasks/backlog/current/2026-09-03-LOW-DOCUMENTATION-CLEANUP-PHASE05-LUNA-CALIBRATION.md

STEP 0 — MOVE TASK FILE BEFORE ANYTHING ELSE (no exceptions):
  git mv projects/galaxy_game/tasks/backlog/current/2026-09-03-LOW-DOCUMENTATION-CLEANUP-PHASE05-LUNA-CALIBRATION.md \
         projects/galaxy_game/tasks/active/2026-09-03-LOW-DOCUMENTATION-CLEANUP-PHASE05-LUNA-CALIBRATION.md
...
LIFECYCLE: backlog → active → completed
  ...
  - Verify with: find agent-tasks/projects/galaxy_game/tasks -name "2026-09-03-LOW-DOCUMENTATION-CLEANUP-PHASE05-LUNA-CALIBRATION.md"
...
CRITICAL: Save synthesis report as MD file to summaries folder BEFORE starting any work.
  ...
  Filename pattern: 2026-09-03-CLEANUP-phase05-luna-calibration.md
  Chat is for questions only — never paste synthesis into chat (formatting breaks).
```

---

# TASK: Cleanup sweep — backlog/phase05-luna-calibration/ (1 task files)
**Status**: BACKLOG
**Priority**: LOW
**Type**: documentation
**Created**: 2026-09-03
...
This task covers the `backlog/phase05-luna-calibration/` folder specifically.

## Problem Statement

Task files in `backlog/phase05-luna-calibration/` may have:
...
### Step 1 — Inventory
List all .md files in `backlog/phase05-luna-calibration/` (excluding README.md).
...
### Step 6 — Verify
```bash
find /Users/tam0013/Documents/git/agent-tasks/projects/galaxy_game/tasks -name "*.md" -path "*/phase05-luna-calibration/*" | wc -l
```
...
git commit -m "chore: cleanup sweep backlog/phase05-luna-calibration/ — [summary of fixes]"
```

## Acceptance Criteria
- [ ] All files in `backlog/phase05-luna-calibration/` inventoried
