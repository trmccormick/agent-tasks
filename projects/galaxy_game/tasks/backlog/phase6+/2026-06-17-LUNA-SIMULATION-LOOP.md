...
relocation_rationale: |
  This task describes **expansion decision logic AFTER initial Luna settlement bootstrap is proven**.
  Phase 5 is focused on the Luna Precursor V2 bootstrap sequence (power_comms, isru_deployment, gas_processing phases).
  This expansion planning task belongs in phase6+ (lava-tube base and infrastructure expansion).
  The rake task luna_mission:execute handles the phase5 bootstrap.
  This task should start AFTER that bootstrap is validated.
---
