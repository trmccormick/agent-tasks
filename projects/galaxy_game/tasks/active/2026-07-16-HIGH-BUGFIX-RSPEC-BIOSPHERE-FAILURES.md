...
- [ ] `biosphere_spec.rb:650` passes consistently
- [ ] `biosphere_generator_service_spec.rb:219` passes consistently (run 3x to verify no flakiness)
- [ ] All other biosphere specs still pass (no regressions)
- [ ] Both fixes are test-only (no production code changes)
...
**Fix 1**: [what was done]
**Fix 2**: [what was done]
**Verified**: [paste final spec output]
