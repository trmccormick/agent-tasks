...
- [ ] All 7 phases present with matching phase_ids from profile
- [ ] Hardware counts and roles are realistic for each phase
- [ ] Transit timing matches profile (Titan 730d, Venus 400d)
- [ ] Venus refuel_dependency includes all source options
- [ ] No world-name hardcoding (uses planet properties pattern)
- [ ] Follows manifest_v2 schema pattern (verified against existing manifests)
- [ ] JSON is valid
