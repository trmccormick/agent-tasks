...
## Current Status
- **Status:** ✅ **SOFT LAUNCH READY** — All GitHub issue fixes complete + infrastructure cascade resolved + facet label fix applied
- **Active Branches:**
  - `main` — Stable; production-ready with full volume mount structure
  - `fix/facet-links-and-hide-type-facet` — ✅ ALL FIXES COMPLETE (GitHub issues #11, #13, #14 + infrastructure cascades + facet label i18n fix)
...
- **Last Update:** 2026-08-04 — ✅ FACET LABEL FIX APPLIED + STACK CAR PROPER USAGE

---

## 🔧 2026-08-04 — Facet Display Fix (NEW)
...
2. `app/controllers/catalog_controller_decorator.rb` — Only removes 'generic_type_sim' facet (Hyku #3072 workaround)
...
**Branch**: `fix/facet-links-and-hide-type-facet` at commit 00e5ace with i18n facet translation fix. Branch is clean and stable, ready for merge pending approval.
